...
function NavPill({
  ...
  // IMPORTANT: This avoids the “white pill / invisible text” issue on iPad Safari.
  return (
    <a
      href={href}
      className="
...
export default function Page() {
  const CONTENT = useMemo(
    () => ({
      ...
      tagline:
        "Framing, foundations, siding, and custom builds—done right.",
      serviceAreas: [
        "Bonnyville",
        "Lakeland County",
        "Cold Lake",
      ...
      services: [
        {
          ...
          short:
            "New builds, additions, and structural framing with clean lines and solid scheduling.",
          ...
          detail: {
            ...
            copy:
              "We build straight, square, and strong. Whether it’s a new home, shop, commercial space, or an addition—our framing work is planned for efficiency and built to last.",
            list: [
              "Wall & roof systems",
              "Beam installs & structural tie-ins",
              "Garage and shop packages",
              "Site-ready scheduling & coordination",
            ],
          },
        },
        {
          ...
          title: "Foundations",
          short:
            "Footings, forms, and foundation coordination—built for Alberta conditions.",
          ...
          detail: {
            ...
            copy:
              "Good builds start below grade. We help with layout, forming coordination, and making sure the foundation work is ready for the next stage—no surprises.",
            list: [
              "Footings and form coordination",
              "Garage pads & additions",
              "Prep for framing start",
              "Moisture/grade considerations",
            ],
          },
        },
        {
          ...
          title: "Siding",
          short:
            "Durable exterior finishes installed with attention to detail and weatherproofing.",
          ...
          detail: {
            ...
            copy:
              "Clean lines, tight details, and proper weatherproofing. We install siding and exterior trims with the goal of looking great—and staying that way.",
            list: [
              "Siding installs & upgrades",
              "Corners, trims, soffit/fascia",
              "Flashing details",
        ...
        },
        {
          ...
          title: "Shops",
          short:
            "Workshops and storage buildings built for function, strength, and long-term use.",
          ...
          detail: {
            ...
            copy:
              "From smaller backyard shops to larger workspaces—built to suit your needs, layout, and timeline.",
            list: [
              "Layout and planning support",
              "Foundation-to-frame coordination",
              "Open spans and structural planning",
        ...
        },
        {
          ...
          title: "Pole Barns",
          short:
            "Cost-effective agricultural and storage buildings—designed for Alberta conditions.",
          ...
          detail: {
            ...
            copy:
              "Pole barn construction that’s straightforward, efficient, and built with the right details for wind and snow load.",
            list: [
              "Agricultural and equipment storage",
              "Simple, strong structures",
              "Scheduling and trade coordination",
              "Exterior options: steel, siding, trim",
            ],
          },
        },
        {
          ...
          short:
            "Bright, comfortable spaces that extend your season and your square footage.",
          ...
          detail: {
            ...
            copy:
              "Sunrooms are a high-impact upgrade—more light, more comfort, more usable months. We build them to match your home and handle Alberta weather.",
            list: [
              "New sunrooms & additions",
        ...
        },
        {
          ...
          title: "Custom Saunas",
          short:
            "Built to your space—heat, ventilation, and finishing handled the right way.",
          ...
          detail: {
            heading: "Sauna",
            copy:
              "A proper sauna is more than heat—it’s airflow, materials, and moisture control. We can build to your layout and finish style, including cedar interiors and lighting details.",
            list: [
              "Custom layout to fit your space",
              "Ventilation & moisture control",
              "Cedar/wood interior finishing",
              "Door, bench, and lighting options",
            ],
          },
        },
        {
          ...
          short:
            "One point of contact—from planning through trades and final walkthrough.",
          ...
          detail: {
            ...
            copy:
              "We can run your build or renovation as the general contractor—keeping the trades aligned, schedules tight, and quality consistent.",
            list: [
              "Scope planning & budgeting",
              "Trade scheduling & coordination",
              "Material planning",
              "Site checks & final walkthrough",
            ],
          },
        },
      ],
      projects: [
        {
          ...
          summary:
            "Full framing package with efficient scheduling and clean structural tie-ins.",
        ...
        },
        {
          ...
          summary:
            "Garage/shop build coordination—foundation readiness through framing completion.",
        ...
        },
        {
          ...
          summary:
            "Exterior refresh with tight trim details and weatherproof finishing.",
      ...
      testimonials: [
        {
          ...
          location: "Bonnyville",
          text:
            "Great communication and solid workmanship. The crew was on time, clean, and the framing turned out perfect.",
        },
        {
          id: "t-2",
          name: "Shop owner",
          location: "Lakeland County",
          text:
            "Professional start to finish. They kept the schedule tight and the quality was excellent.",
        },
        {
          id: "t-3",
          ...
          location: "Cold Lake area",
          text:
            "Very detail-oriented—especially on the exterior finishing. Would hire again.",
        },
      ],
      mapEmbedUrl:
        "https://www.google.com/maps?q=Bonnyville,+AB+T9N+2P4&output=embed",
    }),
    []
  );
  ...
  // Sound (iPad/iPhone requires a click/tap; this button makes it work)
  ...
  const playSaw = async () => {
    try {
      ...
      // Autoplay restrictions or missing file — ignore safely.
    }
  };
  ...
  const featuredServices = useMemo(() => {
    ...
    return CONTENT.featuredServiceIds
      ...
      <div className="sticky top-0 z-50 border-b border-white/10 bg-slate-950/90 backdrop-blur">
        <div className="mx-auto max-w-6xl px-4 py-3">
          <div className="flex items-center gap-3">
            {/* Logo block: bigger + never cropped */}
            <div className="flex items-center gap-3 min-w-0">
              <div className="shrink-0 grid h-12 w-12 place-items-center rounded-xl bg-white p-1.5 shadow-sm">
                <img
                  src={CONTENT.brand.logo}
                  alt="Lifestyle Homes & Services logo"
            ...
            {/* iPad/Desktop nav: scrollable so it never “breaks” */}
            <div className="hidden md:flex flex-1 justify-center px-3">
              <div className="flex items-center gap-2 overflow-x-auto py-1">
                ...
                <NavPill href="#testimonials">Reviews</NavPill>
            ...
            <div className="hidden md:flex shrink-0">
              <a
                ...
                className="inline-flex items-center justify-center h-11 px-5 rounded-full bg-orange-500 text-white font-semibold hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-300"
              >
          ...
          <div className="grid gap-10 md:grid-cols-2">
            ...
            >
              ...
              <motion.p
                variants={fadeUp}
                custom={2}
                className="mt-5 max-w-prose text-base leading-relaxed text-slate-600"
              >
              ...
              <motion.div
                variants={fadeUp}
                custom={4}
                className="mt-8 flex flex-wrap gap-3 text-sm text-slate-700"
              >
                ...
                <div key={cat} className="space-y-4">
                  ...
                  <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                    {grouped[cat].map((s: any, i: number) => {
                      ...
                      return (
                        <motion.div key={s.id} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.2 }} variants={fadeUp} custom={i}>
        ...
        <div className="mx-auto max-w-6xl px-4 py-14">
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {CONTENT.projects.map((p: any, i: number) => (
              <motion.div key={p.id} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.2 }} variants={fadeUp} custom={i}>
      ...
      <footer className="border-t border-slate-200 bg-white">
        <div className="mx-auto max-w-6xl px-4 py-10">
          <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            <div className="flex items-center gap-3 min-w-0">
              <div className="grid h-12 w-12 place-items-center rounded-xl bg-slate-50 p-1.5 border border-slate-200">
                ...
                <div className="flex items-start justify-between gap-4">
                  <div>
                    ...
                    <DialogDescription className="mt-1">
                      Search by keyword (ex: “shop”, “pole”, “siding”, “sauna”).
                    </DialogDescription>
                  </div>
